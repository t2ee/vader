...
class Router {
    ...
    getBody(route, koaContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (route.consume === MediaType_1.default.JSON &&
                ...
                contentType.indexOf(MediaType_1.default.toString(MediaType_1.default.TEXT)) !== -1) {
                return yield new Promise((resolve, reject) => {
    ...
    getIParameterValue(parameter, context) {
    ...
    getIParameter(parameter, context) {
                    ...
                    return () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        for (const key in controllerClass.prototype[Property].params) {
                            controllerClass.prototype[key] =
                                self.getIParameter(controllerClass.prototype[Property].params[key], context);
                        }
